...
- For access-point-specific queries, prefer `central_get_aps` and use `central_get_ap_latest_stats` when the user asks about a specific AP's CPU, memory, or power state.
